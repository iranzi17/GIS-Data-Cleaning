...
def _fill_supervisor_batch(
    ...
    shared_deps = FillBatchDependencies(**{**FILL_BATCH_DEPS.__dict__, "fill_one_gpkg": fill_one_gpkg_fn})
    return fill_supervisor_batch(
        files,
        device_options,
        sup_wb_path,
        sup_sheet,
        ...
        id_validation_rows=id_validation_rows,
    )
    logs: list[str] = []
    ...
    for file_obj in files:
        ...
        try:
            ...
            out_path, used_layer = fill_one_gpkg_fn(
                file_obj,
                device_for_file,
